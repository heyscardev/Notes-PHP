    ...
    <div class="col-10 col-md-4"> 
       <form class=" bg-white rounded p-4 needs-validation "  method="post">
          <div class="mx-2 my-3 mx-lg-3 my-lg-4  justify-content-center">
            ...
            <div class=" text-center">
              <button type="submit"
                class="btn btn-outline-secondary     border-4 border-primary text-primary  fw-bolder">Registrar</button>
            </div>
            <div class="text-center mt-3 row">
              <label for="" class=" fs-6 text-black-50">¿ya tienes una cuenta?</label>
              <a class=" bolder text-primary text-primary text-decoration-none animate__animated animate__pulse animate__infinite fw-bolder" type="button" data-bs-toggle="collapse" data-bs-target="#collapselogin"
            aria-expanded="true" aria-controls="collapselogin">Inicia Sesion</a>

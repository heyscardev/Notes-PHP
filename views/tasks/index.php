    ...
    <table class="table  table-primary border-5 border-white border  rounded table-hover">
      <thead class="text-primary fw-bolder">
        <tr class="text-center text-primary">
          <th>Codigo de Periodo</th><!--1-->
          <th>Corte</th>
          <th>Materia</th><!--2-->
          <th>Tarea</th><!--3-->
          <th>descripcion</th><!--4-->
          <th>peso Neto</th><!--5-->
          <th>dia de entrega</th><!--6-->
          <th>Nota estudiante</th><!--7-->
      ...
      <tbody class="text-primary">
        ...
        ?>
          ...
          <tr class=" text-center overflow-overflow-hidden lh-lg">
            ...
            <!--1--><td><?php echo $dato["period"]->getCodPeriod(); ?></td>
            <!--2--><td><?php echo $dato["task"]->getNCorte(); ?></td>
            <!--3--><td><?php echo $dato["subject"]->getName(); ?></td>
            <!--4--><td><?php echo $dato["task"]->getName(); ?></td>
            <!--5--><td><?php echo $dato["task"]->getDescription(); ?></td>
            <!--6--><td><?php echo $dato["task"]->getSubjectNote(); ?>%</td>
            <!--7--><td><?php echo $dato["task"]->getDeliverDate(); ?></td>
             <!--8--><td><?php echo $dato["task"]->getDeliverDate(); ?></td>
        ...
        <div class="modal-body py-2 bg-secondary">
          ...
          <div class="col-md-12">
              ...
              <div class="input-group has-validation">
                ...
                ?>
                <option value=<?php echo $und->getIdPeriod(); ?>> <?php echo $und->getCodPeriod();?> 
